class Solution {
    public String triangleType(int[] nums) {
        ...
        private boolean isTriangle(int[] nums){
            return nums[1]+nums[2]>nums[0] && nums[2]+nums[0]>nums[1] && nums[1]+nums[0]>nums[2];
        }
        private boolean isEquilateral(int[] nums){
            return nums[1]==nums[2] && nums[2]==nums[0];
        }
        private boolean isIsosceles(int[] nums){
            return nums[1]==nums[2] || nums[2]==nums[0] ||nums[0]==nums[1];
        }
}
